...
final class SamlAttribute
{
    ...
    public const string eduPersonPrimaryAffiliation = 'urn:oid:1.3.6.1.4.1.5923.1.1.1.5';
    ...
    public const string templeEduGivenName = 'urn:oid:1.3.6.1.4.1.44987.1.1.2.1.24';
    public const string templeEduSn = 'urn:oid:1.3.6.1.4.1.44987.1.1.2.1.25';
